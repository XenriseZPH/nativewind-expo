import {
  ...
  Overlay as SelectOverlayPrimitive,
  ...
  useRootContext as useSelectRootContext,
...
function SelectContent({
  ...
  return (
    <SelectPortalPrimitive hostName={portalHost}>
      <FullWindowOverlay>
        <SelectOverlayPrimitive style={Platform.select({ native: StyleSheet.absoluteFill })}>
...
function SelectItem({ className, ...props }: React.ComponentProps<typeof SelectItemPrimitive>) {
  return (
    <SelectItemPrimitive
      className={cn(
    ...
    >
      ...
      <SelectItemTextPrimitive className="text-sm text-foreground select-none group-active:text-accent-foreground" />
    </SelectItemPrimitive>
  );
}
